...
use Yii;
use app\models\teacher\information\Information;
use app\models\teacher\information\InformationSearch;
 ...
 */
class InformationController extends TeacherCommonController
{
    /**
     * @inheritdoc
     */
    ...
    public function actionIndex()
	{
		...
		$result = (new \yii\db\Query())->from('teacher')
			->where('id='.$id)
			->one();
